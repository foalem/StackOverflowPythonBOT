...
namespace StackOverflowPythonBOT.Bots
{
    public class DialogAndWelcomeBot : ActivityHandler
    {
        ...
        private const string WelcomeMessage = "Hello I am a Python StackOverflow BOT. " +
                                               "Using Microsoft AI, I'm here to help extend your capabilise" +
                                               "free you up for more creative endeavour, and assist you in achieving more.";
